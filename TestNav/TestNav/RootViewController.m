...
- (void)viewDidLoad
{
    [super viewDidLoad];
    self.title = @"Root";
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"ControllerA" style:UIBarButtonItemStyleBordered target:self action:@selector(go)];
}
